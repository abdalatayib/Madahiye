...
export const translations: Translations = {
  ...
  paymentInfoTitle: { so: 'Lacagta Bixinta', en: 'Payment Instructions', ar: 'تعليمات الدفع' },
  paymentInfoText: { so: 'Ku bixinta lacagta mobilka ee lambarkan ka hor ama kadib markaad codsiga dirto.', en: 'Send payment using the mobile money number below before or after posting.', ar: 'أرسل الدفع عبر رقم المال المتنقل أدناه قبل أو بعد النشر.' },
  senderPhone: { so: 'Lambarka Aad Lacagta Ka Bixisay', en: 'Number Money Sent From', ar: 'رقم المرسل' },
  senderPhonePlaceholder: { so: 'Geli lambarka taleefanka aad lacagta ka soo dirtay', en: 'Enter the phone number you sent money from', ar: 'أدخل رقم الهاتف الذي أرسلت منه المال' },
  whatsappNumber: { so: 'Lambarka WhatsApp', en: 'WhatsApp Number', ar: 'رقم واتساب' },
  whatsappNumberPlaceholder: { so: 'Geli lambarka WhatsApp ee laguugu soo xidhiidhi karo', en: 'Enter the WhatsApp number to contact you', ar: 'أدخل رقم الواتساب للتواصل معك' },
  evcNumber: { so: 'Lambarka EVC', en: 'EVC Number', ar: 'رقم EVC' },
  evcNumberPlaceholder: { so: 'Geli lambarka EVC', en: 'Enter your EVC number', ar: 'أدخل رقم EVC الخاص بك' },
  callPhone: { so: 'Lambarka Taleefanka', en: 'Call Phone Number', ar: 'رقم الهاتف' },
  callPhonePlaceholder: { so: 'Geli lambarka taleefanka laguugu yeeri karo', en: 'Enter the phone number callers can reach you on', ar: 'أدخل رقم الهاتف الذي يمكن الاتصال بك عليه' },
  sendMoneyTo: { so: 'Ku Bixi Lacagta', en: 'Send Money To', ar: 'أرسل المال إلى' },
  sentFrom: { so: 'Lacag laga soo diray', en: 'Sent From', ar: 'أُرسلت من' },
  noPhoneProvided: { so: 'Lambarka taleefanka lama bixin', en: 'Phone number not provided', ar: 'لم يتم تقديم رقم الهاتف' },
  noWhatsappProvided: { so: 'WhatsApp lama bixin', en: 'WhatsApp not provided', ar: 'لم يتم تقديم واتساب' },
  adminPanel: { so: 'Guddi Maamulka', en: 'Admin Panel', ar: 'لوحة الإدارة' },
  adminOverview: { so: 'Dulmarko Maamulka', en: 'Admin Overview', ar: 'نظرة عامة للمسؤول' },
  totalRequests: { so: 'Wadarta Codsiyada', en: 'Total Requests', ar: 'إجمالي الطلبات' },
  openRequests: { so: 'Codsiyada Furan', en: 'Open Requests', ar: 'الطلبات المفتوحة' },
  cancelledRequests: { so: 'Codsiyada La Joojiyay', en: 'Cancelled Requests', ar: 'الطلبات الملغاة' },
  adminNoRequests: { so: 'Ma jiraan codsiyo loo baahan yahay in la maamulo.', en: 'There are no requests to manage.', ar: 'لا توجد طلبات لإدارتها.' },
  markCompleted: { so: 'Calaami Dhamaystiran', en: 'Mark Completed', ar: 'وضع علامة مكتمل' },
  markPaid: { so: 'Calaami Lacag Lagu Bixiyay', en: 'Mark as Paid', ar: 'وضع علامة مدفوع' },
  cancelRequest: { so: 'Jooji Codsiga', en: 'Cancel Request', ar: 'إلغاء الطلب' },
  ...
  paid: { so: 'Lacag Lagu Bixiyay', en: 'Paid', ar: 'مدفوع' },

  // New features
  myPosts: { so: 'Qoraaladayda', en: 'My Posts', ar: 'منشوراتي' },
  profile: { so: 'Profile', en: 'Profile', ar: 'الملف الشخصي' },
  personalInfo: { so: 'Macluumaadka Shakhsiga', en: 'Personal Information', ar: 'المعلومات الشخصية' },
  donationStats: { so: 'Tirakoobka Deeqaha', en: 'Donation Statistics', ar: 'إحصائيات التبرعات' },
  totalDonations: { so: 'Wadarta Deeqaha', en: 'Total Donations', ar: 'إجمالي التبرعات' },
  lastDonation: { so: 'Deeqdii Ugu Dambaysay', en: 'Last Donation', ar: 'التبرع الأخير' },
  name: { so: 'Magaca', en: 'Name', ar: 'الاسم' },
  email: { so: 'Imeel', en: 'Email', ar: 'البريد الإلكتروني' },
  rating: { so: 'Qiimeyn', en: 'Rating', ar: 'التقييم' },
  edit: { so: 'Wax ka beddel', en: 'Edit', ar: 'تعديل' },
  delete: { so: 'Tirtir', en: 'Delete', ar: 'حذف' },
  markSuccess: { so: 'Calaami Guul', en: 'Mark Success', ar: 'وضع علامة نجاح' },
  confirmDelete: { so: 'Ma hubtaa inaad rabto inaad tirtirto codsigan?', en: 'Are you sure you want to delete this request?', ar: 'هل أنت متأكد من أنك تريد حذف هذا الطلب؟' },
  editRequest: { so: 'Wax ka beddel Codsiga', en: 'Edit Request', ar: 'تعديل الطلب' },
  updateRequest: { so: 'Cusboonaysii Codsiga', en: 'Update Request', ar: 'تحديث الطلب' },
};
